...
const ac_xpu_hw_addr_mask_offset g_ac_xpu_hw_addr_mask_offset[] = {
	{HAL_XPU2_BOOT_ROM,          0xFFFFFFFF, 0x300000  },
	{HAL_XPU2_CNOC_APSS_CFG_MPU, 0xFFFFFFFF, 0xF000000 },
	{HAL_XPU2_CNOC_CE_EDPD_MPU,  0xFFFFFFFF, 0x00200000},
	{HAL_XPU2_CNOC_PMU_CFG_MPU,  0xFFFFFFFF, 0x0009A000},
	{HAL_XPU2_CNOC_QDSS_CFG_MPU, 0xFFFFFFFF, 0x6000000 },
	{HAL_XPU2_CNOC_WCSS_SLV_MPU, 0xFFFFFFFF, 0xC000000 },
	{HAL_XPU2_GEMNOC_CFG_MPU,    0xFFFFFFFF, 0x00800000},
	{HAL_XPU2_IMEM_MPU,          0xFFFFFFFF, 0x8600000 },
	{HAL_XPU2_TLMM,              0xFFFFFFFF, 0x1000000 },
	{HAL_XPU2_WCSS_XPU_CFG,      0xFFFFFFFF, 0x0C000000},
	{HAL_XPU2_MPM2_MPM_APU,      0xFFFFFFFF, 0x004A0000},
	{HAL_XPU2_IMEM_APU,          0xFFFFFFFF, 0x50000   },
	{HAL_XPU2_PRNG_APU,          0xFFFFFFFF, 0x4C0000  },
	{HAL_XPU2_Q6_CFG_XPU,        0xFFFFFFFF, 0x8C00000 },
	{HAL_XPU2_QDSS_CFG_DCC_DCC,  0xFFFFFFFF, 0x6000000 },
	{HAL_XPU2_SEC_CTRL_APU,      0xFFFFFFFF, 0xA0000   },
	{HAL_XPU2_TCSR_REGS,         0xFFFFFFFF, 0x01900000},
	{HAL_XPU2_QUPV3_5_GSI_TOP,   0xFFFFFFFF, 0x1A00000 },
...
const ac_xpu_err_mapping_t g_ac_xpu_err_pos_to_xpu_map[XPU_ERR_INT_REG_NUM][XPU_ERR_NUM_PER_REG] = {
	{
		...
		{.xpu_id = HAL_XPU2_GEMNOC_CFG_MPU, .name = "HAL_XPU2_GEMNOC_CFG_MPU"}, //Bit 7
		{.xpu_id = HAL_XPU2_DDR_PHY_CFG_MPU, .name = "HAL_XPU2_DDR_PHY_CFG_MPU"}, //Bit 8
		{.xpu_id = HAL_XPU2_MACHX_LLCC_SCID_MPU, .name = "HAL_XPU2_MACHX_LLCC_SCID_MPU"}, //Bit 9
		{.xpu_id = HAL_XPU2_MACHX_LLCC_MPU, .name = "HAL_XPU2_MACHX_LLCC_MPU"}, //Bit 10
		...
		{.xpu_id = HAL_XPU2_SDCC_XPU_CFG, .name = "HAL_XPU2_SDCC_XPU_CFG"}, //Bit 19
		{.xpu_id = HAL_XPU2_Q6_CFG_XPU, .name = "HAL_XPU2_Q6_CFG_XPU"}, //Bit 20
		{.xpu_id = HAL_XPU2_WCSS_XPU_CFG, .name = "HAL_XPU2_WCSS_XPU_CFG"}, //Bit 21
		...
		{.xpu_id = HAL_XPU2_CNOC_WCSS_SLV_MPU, .name = "HAL_XPU2_CNOC_WCSS_SLV_MPU"}, //Bit 24
		{.xpu_id = HAL_XPU2_XS_PCIE_2LANE_1_MPU, .name = "HAL_XPU2_XS_PCIE_2LANE_1_MPU"}, //Bit 25
		{.xpu_id = HAL_XPU2_XS_PCIE_2LANE_0_MPU, .name = "HAL_XPU2_XS_PCIE_2LANE_0_MPU"}, //Bit 26
		{.xpu_id = HAL_XPU2_XS_PCIE_1LANE_1_MPU, .name = "HAL_XPU2_XS_PCIE_1LANE_1_MPU"}, //Bit 27
		{.xpu_id = HAL_XPU2_XS_PCIE_1LANE_0_MPU, .name = "HAL_XPU2_XS_PCIE_1LANE_0_MPU"}, //Bit 28
		{.xpu_id = HAL_XPU2_MPM2_MPM_APU, .name = "HAL_XPU2_MPM2_MPM_APU"}, //Bit 29
		{.xpu_id = HAL_XPU2_CNOC_USBPHY_USB2_CORE_PHY_CFG_MPU, .name = "HAL_XPU2_CNOC_USBPHY_USB2_CORE_PHY_CFG_MPU"}, //Bit 30
		{.xpu_id = HAL_XPU2_CNOC_PMU_CFG_MPU, .name = "HAL_XPU2_CNOC_PMU_CFG_MPU"}, //Bit 31
	},
	{
		...
		{.xpu_id = HAL_XPU2_CNOC_PCIE_CFG_MPU, .name = "HAL_XPU2_CNOC_PCIE_CFG_MPU"}, //Bit 2
		{.xpu_id = HAL_XPU2_CNOC_CMN_PLL_CFG_MPU, .name = "HAL_XPU2_CNOC_CMN_PLL_CFG_MPU"}, //Bit 3
		{.xpu_id = HAL_XPU2_CNOC_CE_EDPD_MPU, .name = "HAL_XPU2_CNOC_CE_EDPD_MPU"}, //Bit 4
		{.xpu_id = HAL_XPU2_CNOC_APSS_CFG_MPU, .name = "HAL_XPU2_CNOC_APSS_CFG_MPU"}, //Bit 5
...
/*MD5:418abf47adbaa13322356b21e4d79ee6*/
