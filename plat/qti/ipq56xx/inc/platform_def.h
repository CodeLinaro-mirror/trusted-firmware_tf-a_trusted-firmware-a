...
/* No. of cores in the cluster (3x Cortex-A55 + 1x Cortex-A78) */
...
#define BASE_GICR_BASE		0xF240000
...
/*----------------------------------------------------------------------------*/
#define QTI_DEVICE_BASE				0x00000000
...
/*----------------------------------------------------------------------------*/
/* Access Control XPU interrupt definitions */
/*----------------------------------------------------------------------------*/
#define NOTIFY_KERNEL_IRQ			88
/*----------------------------------------------------------------------------*/
 ...
 */
#define PCIE_MSI_INT_BASE         800
#define PCIE_MSI_INT_END          959
