...
static const interrupt_prop_t qti_interrupt_props[] = {
	...
	INTR_PROP_DESC(QTISECLIB_INT_ID_NON_SEC_WDOG_BITE,
		       ...
		       GIC_INTR_CFG_LEVEL),
#endif
#ifdef QTISECLIB_INT_ID_XPU_VIOLATION
	INTR_PROP_DESC(QTISECLIB_INT_ID_XPU_VIOLATION,
		       GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0,
		       GIC_INTR_CFG_LEVEL),
#endif
#ifdef QTISECLIB_INT_ID_VMIDMT_ERR_CLT_SEC
	INTR_PROP_DESC(QTISECLIB_INT_ID_VMIDMT_ERR_CLT_SEC,
		       GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0,
		       GIC_INTR_CFG_EDGE),
#endif
#ifdef QTISECLIB_INT_ID_VMIDMT_ERR_CLT_NONSEC
	INTR_PROP_DESC(QTISECLIB_INT_ID_VMIDMT_ERR_CLT_NONSEC,
		       GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0,
		       GIC_INTR_CFG_EDGE),
#endif
#ifdef QTISECLIB_INT_ID_VMIDMT_ERR_CFG_SEC
	INTR_PROP_DESC(QTISECLIB_INT_ID_VMIDMT_ERR_CFG_SEC,
		       GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0,
		       GIC_INTR_CFG_EDGE),
#endif
#ifdef QTISECLIB_INT_ID_VMIDMT_ERR_CFG_NONSEC
	INTR_PROP_DESC(QTISECLIB_INT_ID_VMIDMT_ERR_CFG_NONSEC,
		       GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0,
		       GIC_INTR_CFG_EDGE),
#endif
#ifdef QTISECLIB_INT_ID_XPU_SEC
	INTR_PROP_DESC(QTISECLIB_INT_ID_XPU_SEC, GIC_HIGHEST_SEC_PRIORITY,
		       INTR_GROUP0,
		       GIC_INTR_CFG_EDGE),
#endif
#ifdef QTISECLIB_INT_ID_XPU_NON_SEC
	...
	INTR_PROP_DESC(QTISECLIB_INT_ID_LPASS_AGNOC_ERROR, GIC_HIGHEST_SEC_PRIORITY,
		       ...
		       GIC_INTR_CFG_EDGE),
#endif
#ifdef QTISECLIB_INT_ID_C1_NOC_ERROR
	INTR_PROP_DESC(QTISECLIB_INT_ID_C1_NOC_ERROR,
		       GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0,
		       GIC_INTR_CFG_LEVEL),
#endif
#ifdef QTISECLIB_INT_ID_C2_NOC_ERROR
	INTR_PROP_DESC(QTISECLIB_INT_ID_C2_NOC_ERROR,
		       GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0,
		       GIC_INTR_CFG_LEVEL),
#endif
#ifdef QTISECLIB_INT_ID_GEM_NOC_ERROR
	INTR_PROP_DESC(QTISECLIB_INT_ID_GEM_NOC_ERROR, GIC_HIGHEST_SEC_PRIORITY,
		       INTR_GROUP0,
		       GIC_INTR_CFG_LEVEL),
#endif
#ifdef QTISECLIB_INT_ID_SNOC_ERROR
	INTR_PROP_DESC(QTISECLIB_INT_ID_SNOC_ERROR,
		       GIC_HIGHEST_SEC_PRIORITY, INTR_GROUP0,
		       GIC_INTR_CFG_LEVEL),
#endif
#ifdef QTISECLIB_INT_ID_AGGR_NOC_ERROR
	INTR_PROP_DESC(QTISECLIB_INT_ID_AGGR_NOC_ERROR, GIC_HIGHEST_SEC_PRIORITY,
		       INTR_GROUP0,
		       GIC_INTR_CFG_LEVEL),
#endif
	...
	INTR_PROP_DESC(QTISECLIB_INT_ID_NSP_NOC_ERROR, GIC_HIGHEST_SEC_PRIORITY,
		       ...
		       GIC_INTR_CFG_EDGE),
#endif
#ifdef QTISECLIB_INT_ID_NSS_NOC_ERROR
	INTR_PROP_DESC(QTISECLIB_INT_ID_NSS_NOC_ERROR, GIC_HIGHEST_SEC_PRIORITY,
		       INTR_GROUP0,
		       GIC_INTR_CFG_LEVEL),
#endif
